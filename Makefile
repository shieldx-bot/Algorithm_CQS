bbalancer:
	docker build -t shieldxbot/balancer:v0.1.15 -f QL/balancer/Dockerfile QL/balancer  
    docker push shieldxbot/balancer:v0.1.15



bbclient: 
	docker build -t shieldxbot/client:v0.1.15 -f QL/client/Dockerfile QL/client
	docker push shieldxbot/client:v0.1.15


bbackend: 
	docker build -t shieldxbot/backend:v0.1.15 -f QL/backend/Dockerfile QL/backend
	docker push shieldxbot/backend:v0.1.15
